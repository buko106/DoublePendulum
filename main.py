...
parser.add_argument("-sampling", default=10, type=int, help="Draw a frame by SAMPLING steps")
parser.add_argument("-interval", default=10, type=float, help="Interval time(ms) between a frame and next one")
